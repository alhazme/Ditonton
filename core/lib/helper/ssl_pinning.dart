...
class SslPinningHelper {
  ...
  Future<bool> isSecure(String url, HttpMethod httpMethod) async {
    try {
      bool checked = false;
      String _fingerprint = 'E0 F6 90 BB E9 D9 51 8A 42 A6 84 02 D8 7F 44 85 EC 38 F8 A3 D3 4D 90 5F EE F7 2C D7 FB B9 52 08';
      List<String> allowedShA256FingerprintList = [_fingerprint];
